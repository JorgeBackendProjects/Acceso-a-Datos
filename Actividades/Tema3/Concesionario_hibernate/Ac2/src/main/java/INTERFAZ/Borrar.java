...
public class Borrar extends javax.swing.JFrame {
    ...
    public void setDatos() {
        switch (nTabla) {
            ...
            case 2:
                ...
                textField.setText("Select co from Coche co where Matricula ='__'");
    ...
    private void initComponents() {
        ...
        titulo1.setText("Borrando datos de la tabla ");
        ...
        titulo2.setText("Borrar los datos?");

        botonActualizar.setText("Borrar");
    ...
    public void borrarCliente() {
        ...
        Cliente cli = entityManager.getReference(Cliente.class, Integer.parseInt(input1.getText()));
    ...
    public void borrarCoche() {
        ...
        Coche co = entityManager.getReference(Coche.class, input1.getText());
    ...
    public void borrarRevision() {
        ...
        Revision r = entityManager.getReference(Revision.class, Integer.parseInt(input1.getText()));
